///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.40.1.8447/W32 for ARM       26/Jul/2015  22:56:20
...
//    List file    =  
//        C:\Users\TimT\Documents\SandBox\ZIGBEE_WATCH_dev\DEV_BOARD\List\MainApplication.s
//
///////////////////////////////////////////////////////////////////////////////
...
??main_0:
        ...
        MOVS     R1,#+1
        LDR.W    R0,??DataTable9_3  ;; 0x400db000
        ...
        BL       GPIOPinWrite
        MOVS     R1,#+16
        LDR.W    R0,??DataTable9_4  ;; 0x400da000
        BL       GPIOPinTypeGPIOOutput
        MOVS     R2,#+0
        MOVS     R1,#+16
        LDR.W    R0,??DataTable9_4  ;; 0x400da000
...
//  454  *          the key event is handled as an emergancy button press.
//  455  *
...
//  479             HAL_TOGGLE_LED2();
        MOVS     R1,#+2
        LDR.N    R0,??DataTable9_3  ;; 0x400db000
        BL       GPIOPinRead
        MVNS     R2,R0
