...
//    List file    =  
//        C:\Users\TimT\Documents\SandBox\ZIGBEE_WATCH_dev\DEV_BOARD\List\hal_lcd.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN _ltoa
        EXTERN bspSpiInit
        EXTERN lcdBufferPrintString
        EXTERN lcdInit
        EXTERN lcdSendBuffer
        EXTERN osal_memcpy
        EXTERN osal_strlen
        EXTERN strlen
...
//  240   if ( tmpLen )
        ...
        CMP      R5,#+0
        BEQ.N    ??HalLcdWriteStringValueValue_0
//  241   {
...
//  281   if ( value > 100 )
        ...
        CMP      R4,#+101
        BLT.N    ??HalLcdDisplayPercentBar_0
//  282     value = 100;
        MOVS     R4,#+100
//  283 
...
??HalLcdDisplayPercentBar_1:
        ...
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R0,R5
        BCC.N    ??HalLcdDisplayPercentBar_2
//  295 
//  296   if ( leftOver >= 5 )
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+5
        BLT.N    ??HalLcdDisplayPercentBar_3
//  297     buf[1+x] = '+';
        MOVS     R1,#+43
        ADD      R2,SP,#+0
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  322   uint32 len = ((strlen(str) > HAL_LCD_MAX_CHARS) ? HAL_LCD_MAX_CHARS : strlen(str));
        ...
        BL       strlen
        CMP      R0,#+22
        BCC.N    ??HalLcd_HW_WriteLine_0
        MOVS     R0,#+21
        B.N      ??HalLcd_HW_WriteLine_1
