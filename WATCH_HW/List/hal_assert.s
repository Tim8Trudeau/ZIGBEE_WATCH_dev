...
//        -Ol
//    List file    =  
//        C:\Users\TimT\Documents\SandBox\ZIGBEE_WATCH_dev\WATCH_HW\List\hal_assert.s
//
///////////////////////////////////////////////////////////////////////////////
...
??halAssertHazardLights_4:
        MOVS     R1,#+8
        LDR.N    R0,??DataTable0_4  ;; 0x400dc000
        BL       GPIOPinRead
        CMP      R0,#+0
        BEQ.N    ??halAssertHazardLights_5
        ADDS     R4,R4,#+1
        B.N      ??halAssertHazardLights_6
...
??halAssertHazardLights_6:
        ...
        MOVS     R4,#+0
        B.N      ??halAssertHazardLights_7
??halAssertHazardLights_8:
        MOVS     R1,#+8
        LDR.N    R0,??DataTable0_4  ;; 0x400dc000
        BL       GPIOPinRead
        CMP      R0,#+0
        BEQ.N    ??halAssertHazardLights_9
        MOVS     R4,#+0
??halAssertHazardLights_9:
        ADDS     R4,R4,#+1
??halAssertHazardLights_7:
        CMP      R4,#+500
        BLT.N    ??halAssertHazardLights_8
        MOVS     R4,#+0
        MOVS     R5,#+0
        B.N      ??halAssertHazardLights_10
??halAssertHazardLights_11:
??halAssertHazardLights_12:
        ADDS     R4,R4,#+1
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        CMP      R4,#+8
        BNE.N    ??halAssertHazardLights_10
        MOVS     R4,#+0
        ADDS     R5,R5,#+1
??halAssertHazardLights_10:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+4
        BGE.N    ??halAssertHazardLights_2
...
??halAssertHazardLights_16:
        ...
        LSLS     R1,R1,R2
        TST      R0,R1
        BEQ.N    ??halAssertHazardLights_11
