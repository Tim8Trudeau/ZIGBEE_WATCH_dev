#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\services\\saddr\\saddr.c"
/****************************************************************************
  Filename:       saddr.c
...
/**************************************************************************************************
 */
#line 44 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\services\\saddr\\saddr.c"
...
#line 45 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\services\\saddr\\saddr.c"
...
#line 46 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\services\\saddr\\saddr.c"
 ...
 * @return      TRUE if addresses are equal, FALSE otherwise
 */
_Bool sAddrCmp(const sAddr_t *pAddr1, const sAddr_t *pAddr2)
{
  if (pAddr1->addrMode != pAddr2->addrMode)
  {
    return 0;
  }
  else if (pAddr1->addrMode == 0)
  {
    return 0;
  }
  else if (pAddr1->addrMode == 2)
  {
    return (_Bool) (pAddr1->addr.shortAddr == pAddr2->addr.shortAddr);
  }
  else if (pAddr1->addrMode == 3)
  {
 ...
 * @return      TRUE if addresses are identical, FALSE otherwise
 */
_Bool sAddrIden(const sAddr_t *pAddr1, const sAddr_t *pAddr2)
{
 ...
 * @return      TRUE if addresses are equal, FALSE otherwise
 */
_Bool sAddrExtCmp(const uint8 * pAddr1, const uint8 * pAddr2)
{
  uint8 i;
...
void *sAddrExtCpy(uint8 * pDest, const uint8 * pSrc)
{
  return osal_memcpy(pDest, pSrc, 8);
}
