#line 1 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
  /*****************************************************************************
  *     program:  AF.c
  ...
  *---------------------------------------------------------------------------
Description:
  This Files contain the Application Frame work functions.
  All function that deal with Zigbee PAN at the application level are found here.
  *****************************************************************************/
 /* ------------------------------------------------------------------------------------------------
  *                                          Includes
  * ------------------------------------------------------------------------------------------------
...
#line 22 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
...
#line 29 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.h"
...
/**************************************************************************************************
*/
#line 23 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
...
#line 24 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\nwk\\nwk_util.h"
/**************************************************************************************************
  Filename:       nwk_util.h
...
#line 25 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\nwk\\aps_groups.h"
/**************************************************************************************************
...
#line 26 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
...
#line 27 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\nwk\\aps_frag.h"
/**************************************************************************************************
  Filename:       aps_frag.h
...
/**************************************************************************************************
*/
#line 28 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\nwk\\rtg.h"
/**************************************************************************************************
  Filename:       rtg.h
  Revised:        $Date: 2014-03-26 10:01:05 -0700 (Wed, 26 Mar 2014) $
...
#line 29 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
...
epList_t *afRegisterExtended( endPointDesc_t *epDesc, pDescCB descFn, pApplCB applFn )
{
  ...
  if (ep != 0)
  {
    ...
    ep->epDesc = epDesc;
    ep->pfnDescCB = descFn;
    ep->apsfCfg.frameDelay = 50;
    ep->apsfCfg.windowSize = 1;
...
afStatus_t afRegister( endPointDesc_t *epDesc )
{
  ...
  return ((0 == afRegisterExtended(epDesc, 0, 0)) ? 0x10 : 0x00);
}
...
void afDataConfirm( uint8 endPoint, uint8 transID, ZStatus_t status )
{
  ...
  if ( msgPtr )
  {
    ...
    msgPtr->hdr.event = 0xFD;
    msgPtr->hdr.status = status;
    msgPtr->endpoint = endPoint;
    msgPtr->transID = transID;

#line 253 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
    {
...
#line 307 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
    {
      /* send message through task message */
      osal_msg_send( *(epDesc->task_id), (uint8 *)msgPtr );
    }
...
{
  endPointDesc_t *epDesc = 0;
  epList_t *pList = epList;

  uint8 grpEp = 0xFE;


  if ( ((aff->FrmCtrl & 0x0C) == 0x0C) )
  {

    // Find the first endpoint for this group
    grpEp = aps_FindGroupForEndpoint( aff->GroupID, 0xFE );
    if ( grpEp == 0xFE )
  ...
  while ( epDesc )
  {
    ...
    if ( (aff->ProfileID == epProfileID) ||
         ((epDesc->endPoint == 0) && (aff->ProfileID == 0)) ||
         ((epDesc->endPoint != 0) && ( aff->ProfileID == 0xFFFF )) )
    {
...
#line 503 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
  {
    // Send message through task message.
 ...
 * @return  afStatus_t - See previous definition of afStatus_... types.
*********************************************************************/
uint8 AF_DataRequestDiscoverRoute = 0x01;
afStatus_t AF_DataRequest( afAddrType_t *dstAddr, endPointDesc_t *srcEP,
                           uint16 cID, uint16 len, uint8 *buf, uint8 *transID,
                           uint8 options, uint8 radius )
{
...
#line 556 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
  ...
  if ( options & 0x08  )
  {
    ...
    if ( (dstAddr->addr.shortAddr != NLME_GetShortAddr())
        && (RTG_CheckRtStatus( dstAddr->addr.shortAddr, 1, (0x01 | 0x02) ) != RTG_SUCCESS) )
    {
  ...
  {
    sAddrExtCpy((req . dstAddr . addr . extAddr), (const uint8 *)(dstAddr->addr . extAddr));
  }
  else
  {
  ...
  if ( ( pList != 0 ) && ( pList->pfnApplCB != 0 ) )
  {
    pList->pfnApplCB( &req );
  }

#line 710 "C:\\Users\\TimT\\Documents\\SandBox\\ZIGBEE_WATCH_dev\\AF.c"
  {
...
static epList_t *afFindEndPointDescList( uint8 EndPoint )
{
  ...
  for (epSearch = epList; epSearch != 0; epSearch = epSearch->nextDesc)
  {
...
void afCopyAddress( afAddrType_t *afAddr, zAddrType_t *zAddr )
{
  ...
  {
    (void)sAddrExtCpy((afAddr->addr . extAddr), (const uint8 *)(zAddr->addr . extAddr));
  }
  else
  {
