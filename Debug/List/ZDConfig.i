#line 1 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\zdo\\ZDConfig.c"
/**************************************************************************************************
  Filename:       ZDConfig.c
...
#line 47 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\zdo\\ZDConfig.c"
...
/**************************************************************************************************
*/
#line 48 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\zdo\\ZDConfig.c"
...
#line 49 "C:\\Texas Instruments\\Z-Stack Mesh 1.0.0\\Components\\stack\\zdo\\ZDConfig.c"
...
void ZDConfig_UpdateNodeDescriptor( void )
{
  ...
  if ( ((0x04) & 0x01) && (zgDeviceLogicalType == 0x00) )
    ZDO_Config_Node_Descriptor.LogicalType = 0x00;
  else if ( 0 )
    ZDO_Config_Node_Descriptor.LogicalType = 0x01;
  else if ( 1 )
    ZDO_Config_Node_Descriptor.LogicalType = 0x02;

  ZDO_Config_Node_Descriptor.ComplexDescAvail = 0;      // set elsewhere
  ZDO_Config_Node_Descriptor.UserDescAvail = 0;         // set elsewhere
  ZDO_Config_Node_Descriptor.Reserved = 0;                  // Reserved
  ZDO_Config_Node_Descriptor.APSFlags = 0;                  // NO APS flags
  ZDO_Config_Node_Descriptor.FrequencyBand = 0x08; // Frequency Band
  ...
  if ( 0 )
  {
    ...
    if ( ((0x04) & 0x01) && (zgDeviceLogicalType == 0x00) )
      ZDO_Config_Node_Descriptor.CapabilityFlags |= 0x01;
  }
  else if ( 1 )
  {
    ZDO_Config_Node_Descriptor.CapabilityFlags = (0x00
  ...
  // Maximum Buffer Size
  ZDO_Config_Node_Descriptor.MaxBufferSize = 80;

  // Maximum Incoming Transfer Size Field
  ZDO_Config_Node_Descriptor.MaxInTransferSize[0] = ((160) & 0xFF);
  ZDO_Config_Node_Descriptor.MaxInTransferSize[1] = (((160) >> 8) & 0xFF);

  // Maximum Outgoing Transfer Size Field
  ZDO_Config_Node_Descriptor.MaxOutTransferSize[0] = ((160) & 0xFF);
  ZDO_Config_Node_Descriptor.MaxOutTransferSize[1] = (((160) >> 8) & 0xFF);
...
void ZDConfig_UpdatePowerDescriptor( void )
{
  ...
  if ( 0 )
  {
    ZDO_Config_Power_Descriptor.PowerMode = 0x00;
    ZDO_Config_Power_Descriptor.AvailablePowerSources = 0x01;
    ZDO_Config_Power_Descriptor.CurrentPowerSource = 0x01;
    ZDO_Config_Power_Descriptor.CurrentPowerSourceLevel = 0x0C;
  }
  else if ( 1 )
  {
    if ( zgPollRate )
      ZDO_Config_Power_Descriptor.PowerMode = 0x01;
    else
      ZDO_Config_Power_Descriptor.PowerMode = 0x02;

    ZDO_Config_Power_Descriptor.AvailablePowerSources = 0x02;
    ZDO_Config_Power_Descriptor.CurrentPowerSource = 0x02;
    ZDO_Config_Power_Descriptor.CurrentPowerSourceLevel = 0x08;
  }
}
